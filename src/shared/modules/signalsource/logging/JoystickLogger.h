/////////////////////////////////////////////////////////////////////////////
// $Id: JoystickLogger.h 6484 2022-01-03 16:59:03Z mellinger $
  ...
  private:
    ...
    class JoystickThread : public Thread
    {
      public:
        ...
        void GetJoyPos(int &x, int &y, int &z, int &b1, int &b2, int &b3, int &b4);

      private:
        JOYCAPS m_joycaps;
        int m_prevXPos, m_prevYPos, m_prevZPos, m_prevButton1, m_prevButton2, m_prevButton3, m_prevButton4;
