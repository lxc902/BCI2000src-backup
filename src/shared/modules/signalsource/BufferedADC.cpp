////////////////////////////////////////////////////////////////////////////////
// $Id: BufferedADC.cpp 6542 2022-02-08 18:56:17Z mellinger $
...
struct BufferedADC::BufferedADCPrivate : Thread
{
    ...
    Time::Interval mBlockDuration, mAcquisitionTimeout, mInitialAcquisitionTimeout;
...
void BufferedADC::Initialize(const SignalProperties &, const SignalProperties &Output)
{
    ...
    d->mAcquisitionTimeout = 2 * sourceBufferSize * d->mBlockDuration;
...
void BufferedADC::Process(const GenericSignal &, GenericSignal &Output)
{
    ...
    if (readPos < 0)
    {
        ...
        {
            bool gotData =
                d->mDataAvailable.Wait(d->mFirstBlock ? d->mInitialAcquisitionTimeout : d->mAcquisitionTimeout);
