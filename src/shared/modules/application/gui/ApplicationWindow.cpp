////////////////////////////////////////////////////////////////////////////////
// $Id: ApplicationWindow.cpp 6698 2022-04-26 16:54:55Z mellinger $
...
struct ApplicationWindow::Data
{
    ...
    struct
    {
        std::string Left, Top, Width, Height, BackgroundColor, HideCursor, Info, Visualize, SpatialDecimation, TemporalDecimation;
    } mParamNames;
...
ApplicationWindow::Data::Visualization::Visualization(ApplicationWindow *pWindow, const std::string &name)
    : BitmapVisualization(name), Thread(false, &mSenderThread), mpWindow(pWindow), mWidth(0), mHeight(0),
      mTickEvent(true), mOnDisplayTick(&Visualization::OnDisplayTick, this),
...
ApplicationWindow::Data::Data(ApplicationWindow *pSelf, const std::string &inName)
    : mpSelf(pSelf), mName(inName), mOnUpdateReceived(&Data::OnUpdateReceived, this),
...
// ApplicationWindow
ApplicationWindow::ApplicationWindow(const std::string &inName) : d(new Data(this, inName))
{
...
void ApplicationWindow::AutoConfig()
{
    ...
    DisplayWindow::SetCursorVisible(Parameter(d->mParamNames.HideCursor)==0);
