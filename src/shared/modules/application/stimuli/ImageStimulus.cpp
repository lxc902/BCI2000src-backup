////////////////////////////////////////////////////////////////////////////////
// $Id: ImageStimulus.cpp 6644 2022-03-29 17:05:55Z mellinger $
                ...
                if (pCodec && ::avcodec_open2(pCodecCtx, pCodec, &optionsDict) >= 0)
                {
                    ...
                    if (::av_read_frame(pFormatContext, &encodedPacket) >= 0)
                    {
                        ...
                        if (!err)
                        {
                            ...
                            ::av_image_alloc(destPic->data, destPic->linesize, decodedFrame->width, decodedFrame->height, destFormat, 1);
