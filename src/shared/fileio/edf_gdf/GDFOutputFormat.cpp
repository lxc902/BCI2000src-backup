////////////////////////////////////////////////////////////////////////////////
// $Id: GDFOutputFormat.cpp 6484 2022-01-03 16:59:03Z mellinger $
...
void GDFOutputFormat::StartRun(std::ostream &os, const std::string &inFileName)
{
    ...
    recording << inFileName.substr(pos == std::string::npos ? 0 : pos + 1);
...
void GDFOutputFormat::StopRun(std::ostream &os)
{
    // Event Table
