////////////////////////////////////////////////////////////////////////////////
// $Id: EDFOutputBase.cpp 6484 2022-01-03 16:59:03Z mellinger $
...
void EDFOutputBase::Preflight(const SignalProperties &, const StateVector &) const
{
...
void EDFOutputBase::Initialize(const SignalProperties &inProperties, const StateVector &)
{
    ...
    for (const auto &state : *States)
    {
        ...
        {
            double digitalMinimum = -1, digitalMaximum = 1 << state.Length();
...
void EDFOutputBase::StartRun(std::ostream &, const std::string &)
{
    mNumRecords = 0;
}

void EDFOutputBase::StopRun(std::ostream &)
{
}
