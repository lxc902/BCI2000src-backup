////////////////////////////////////////////////////////////////////////////////
// $Id: BCI2000FileReader.cpp 6714 2022-05-04 13:19:50Z mellinger $
...
struct BCI2000FileReader::Private
{
    ...
    int mChannels, mHeaderLength, mStatevectorLength;
...
BCI2000FileReader::Private::Private() : mpStatevector(NULL), mpFile(new File), mpBuffer(NULL), mErrorState(NoError)
{
}
...
BCI2000FileReader::BCI2000FileReader() : p(new Private)
{
}

BCI2000FileReader::BCI2000FileReader(const char *inFileName) : p(new Private)
{
    Open(inFileName);
}
