////////////////////////////////////////////////////////////////////////////////
// $Id: BCI2000SessionReader.h 6484 2022-01-03 16:59:03Z mellinger $
...
class BCI2000SessionReader : public BCI2000FileReader
{
  ...
  public:
    ...
    // File access
    virtual BCI2000SessionReader &Open(const char *fileName, int bufferSize = cDefaultBufSize);
    ...
    // Data access
    virtual GenericSignal::ValueType RawValue(int channel, long sample);
    virtual BCI2000SessionReader &ReadStateVector(long sample);
