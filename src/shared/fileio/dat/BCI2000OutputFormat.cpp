////////////////////////////////////////////////////////////////////////////////
// $Id: BCI2000OutputFormat.cpp 6484 2022-01-03 16:59:03Z mellinger $
...
void BCI2000OutputFormat::Preflight(const SignalProperties &inProperties, const StateVector &) const
{
    Parameter("SourceCh");
...
void BCI2000OutputFormat::StartRun(std::ostream &os, const std::string &)
{
...
void BCI2000OutputFormat::StopRun(std::ostream &)
{
}
