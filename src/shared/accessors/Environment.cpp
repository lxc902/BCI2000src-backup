////////////////////////////////////////////////////////////////////////////////
// $Id: Environment.cpp 6790 2022-06-11 13:23:47Z mellinger $
        ...
        if (mpParameters)
        {
            ...
            for (int i = 0; i < mpParameters->Size(); ++i)
            {
                ...
                if (!IsAutoConfigParam(p))
                    notAutoConfig.insert(mpParameters->OriginalPath(&p));
            }
...
std::string Environment::CurrentSession() const
{
    return sRunManager.CurrentSession();
}

std::string Environment::CurrentRun() const
{
    return sRunManager.CurrentRun();
}

class Tiny::File &Environment::CurrentRunFile() const
{
