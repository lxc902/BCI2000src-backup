////////////////////////////////////////////////////////////////////////////////
// $Id: CfgID.h 6655 2022-04-01 17:50:10Z mellinger $
...
class CfgID
{
  public:
    ...
    enum CfgID_ // Must have a name to be used as a template argument.
    {
        ...
        ValueUnits, // allow for different units in different channels
        MinValues,  // allow for different min values in different channels
        MaxValues,  // allow for different max values in different channels
