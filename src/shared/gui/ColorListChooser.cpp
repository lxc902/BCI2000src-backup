////////////////////////////////////////////////////////////////////////////////
// $Id: ColorListChooser.cpp 6484 2022-01-03 16:59:03Z mellinger $
...
const ColorListChooser &ColorListChooser::Display(ColorList &ioColors) const
{
    for (int i = 0; i < std::min(static_cast<int>(ioColors.size()), QColorDialog::customCount()); ++i)
