//////////////////////////////////////////////////////////////////////////////////////
// $Id: ArithmeticExpression.cpp 6605 2022-03-05 19:36:29Z mellinger $
    ...
    static const struct
    {
        ...
        void *function;
                     ...
                     CONSTFUNC1(sqrt)
                         ...
                         CONSTFUNC1(fabs){"abs", true, 1, (void *)static_cast<FunctionNode<1>::Pointer>(&::fabs)},

                     CONSTFUNC2(fmod){"mod", true, 2, (void *)static_cast<FunctionNode<2>::Pointer>(&::fmod)},

                     CONSTFUNC1(floor) CONSTFUNC1(ceil)

                         CONSTFUNC1(exp) CONSTFUNC1(log) CONSTFUNC1(log10)
                             CONSTFUNC2(pow){"^", true, 2, (void *)static_cast<FunctionNode<2>::Pointer>(&::pow)},

                     CONSTFUNC1(sin) CONSTFUNC1(cos) CONSTFUNC1(tan) CONSTFUNC1(asin) CONSTFUNC1(acos) CONSTFUNC1(atan)
                         CONSTFUNC2(atan2) CONSTFUNC1(sinh) CONSTFUNC1(cosh) CONSTFUNC1(tanh)
