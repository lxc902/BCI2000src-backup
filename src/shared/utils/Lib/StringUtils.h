//////////////////////////////////////////////////////////////////////
// $Id: StringUtils.h 6484 2022-01-03 16:59:03Z mellinger $
  ...
  private:
    class IStream
    {
      ...
      public:
        ...
        IStream(const IStream &other) : iss(other.iss)
        {
            const_cast<IStream &>(other).iss = 0;
        }
        ~IStream()
        {
            delete iss;
    ...
    class OStream
    {
      ...
      public:
        ...
        OStream(const OStream &other) : str(other.str), oss(other.oss)
        {
            const_cast<OStream &>(other).oss = 0;
        }
        ~OStream()
        {
            Str();
