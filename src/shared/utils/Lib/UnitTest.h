//////////////////////////////////////////////////////////////////////
// $Id: UnitTest.h 6484 2022-01-03 16:59:03Z mellinger $
...
#define UnitTest(name)                                                                                                 \
    static struct name##_ : Tiny::Test::Base                                                                           \
    {                                                                                                                  \
        name##_() : Tiny::Test::Base(#name)                                                                            \
        {                                                                                                              \
        }                                                                                                              \
      private:                                                                                                         \
        void OnRun_();                                                                                                 \
...
#define TestFail_if(cond, msg)                                                                                         \
    if (cond)                                                                                                          \
        TestFail << #cond << ", " << msg << std::endl;
#define TestRequire(cond)                                                                                              \
    if (!(cond))                                                                                                       \
        TestFail << #cond << " should evaluate to true" << std::endl;
...
#endif
template <class T, int freq = 1> class Random
{
  public:
    Random() : mValue(1)
    {
