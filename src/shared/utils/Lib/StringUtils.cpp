//////////////////////////////////////////////////////////////////////
// $Id: StringUtils.cpp 6484 2022-01-03 16:59:03Z mellinger $
...
NameValueList::Super::iterator NameValueList::find(const String &s)
{
    return std::find_if(this->begin(), this->end(), [s](const value_type &v) { return v.first == s; });
}

NameValueList::Super::const_iterator NameValueList::find(const String &s) const
{
    return std::find_if(this->begin(), this->end(), [s](const value_type &v) { return v.first == s; });
}
