...
struct AudioStream::Data
{
    ...
    SynchronizedObject<String, std::recursive_mutex> mError;
...
const String &AudioStream::Error() const
{
    return *d->mError;
}

const String &AudioStream::DeviceInfo() const
{
    SyncMemory<BeforeRead>();
