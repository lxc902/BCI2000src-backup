...
const String &AVPlayer::Error() const
{
    SyncMemory<BeforeRead>();
...
const String &AVPlayer::File() const
{
    SyncMemory<BeforeRead>();
    return d->mFile;
}

const String &AVPlayer::Codec() const
{
    SyncMemory<BeforeRead>();
    return d->mCodec;
}

const String &AVPlayer::DeviceInfo() const
{
    SyncMemory<BeforeRead>();
    return d->mDeviceInfo;
}

const String &AVPlayer::ContainerFormat() const
{
    SyncMemory<BeforeRead>();
    return d->mContainer;
}
