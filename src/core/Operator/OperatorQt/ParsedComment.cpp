//////////////////////////////////////////////////////////////////////
// $Id: ParsedComment.cpp 6562 2022-02-12 16:32:17Z mellinger $
...
ParsedComment::ParsedComment(const Param &p) : mName(p.Name()), mComment(p.Comment()), mKind(unknown), mIndexBase(0)
{
...
#define HINT(x) {"(" #x ")", x}
        ...
        HINT(color),       HINT(noedit),  HINT(readonly),  HINT(allow_override),
#undef HINT
    };
