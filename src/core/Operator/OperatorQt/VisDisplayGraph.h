////////////////////////////////////////////////////////////////////////////////
// $Id: VisDisplayGraph.h 6562 2022-02-12 16:32:17Z mellinger $
...
class VisDisplayGraph : public VisDisplayLayer
{
  ...
  private:
    ...
    QMenu *mpContextMenu, *mpHPMenu, *mpLPMenu, *mpNotchMenu;
    QAction *mpActEnlargeSignal, *mpActReduceSignal, *mpActToggleAutoScale, *mpActFewerSamples, *mpActMoreSamples,
        *mpActMoreChannels, *mpActFewerChannels, *mpActToggleDisplayMode, *mpActToggleNumericValues,
        *mpActToggleBaselines, *mpActToggleValueUnit, *mpActToggleChannelLabels, *mpActToggleColor, *mpActInvertDisplay,
        *mpActChooseColors, *mpActLargerFont, *mpActSmallerFont;
  ...
  private:
    int mNumChannels, mSignalElements, mUserScaling, mUserZoom;
