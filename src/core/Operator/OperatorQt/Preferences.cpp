//////////////////////////////////////////////////////////////////////
// $Id: Preferences.cpp 6644 2022-03-29 17:05:55Z mellinger $
...
#define PARAM(x) {"--" #x, x},
        PARAM(OnConnect) PARAM(OnExit) PARAM(OnSetConfig) PARAM(OnSuspend) PARAM(OnResume) PARAM(OnStart)
            PARAM(OnShutdown)
#undef PARAM
    };
    int i = 1;
...
void Preferences::ReadSettings()
{
    ...
    mCurrentDir.setPath(settings.value("Config/WorkingDirectory").toString());
