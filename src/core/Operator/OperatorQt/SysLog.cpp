//////////////////////////////////////////////////////////////////////
// $Id: SysLog.cpp 6562 2022-02-12 16:32:17Z mellinger $
...
SysLog::SysLog(MainWindow *inParent)
    : QDialog(inParent, Qt::CustomizeWindowHint | Qt::WindowTitleHint | Qt::WindowCloseButtonHint), mpParent(inParent),
      mpLog(new QTextBrowser), mAttachToParent(true), mEmpty(true), mState(normal), mErrorsDisplayedSoFar(true),
      mURLMatcher("://")
{
