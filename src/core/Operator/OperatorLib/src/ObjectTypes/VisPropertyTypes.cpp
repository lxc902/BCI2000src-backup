////////////////////////////////////////////////////////////////////////////////
// $Id: VisPropertyTypes.cpp 6484 2022-01-03 16:59:03Z mellinger $
...
const ObjectType::MethodEntry VisPropertyType::sMethodTable[] = {METHOD(Set), METHOD(Get), END};
...
bool VisPropertyType::Set(CommandInterpreter &inInterpreter)
{
    ...
    WithLock(inInterpreter.StateMachine()) inInterpreter.StateMachine().Visualizations()[visID].Put(numCfgID, value);
