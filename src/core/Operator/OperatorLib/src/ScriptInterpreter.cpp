////////////////////////////////////////////////////////////////////////////////
// $Id: ScriptInterpreter.cpp 6484 2022-01-03 16:59:03Z mellinger $
...
void ScriptInterpreter::ExecuteAsynchronously(const std::string &inScript, const std::string &inName)
{
...
void ScriptThread::Execute(const std::string &inScript, const std::string &inName)
{
    mScript = inScript;
    mName = inName;
    Thread::Start();
