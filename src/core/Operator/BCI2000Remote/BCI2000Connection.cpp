//////////////////////////////////////////////////////////////////////
// $Id: BCI2000Connection.cpp 6484 2022-01-03 16:59:03Z mellinger $
...
bool BCI2000Connection::Connect()
{
    ...
    bool success = mSocket.connected(), operatorRunning = success;
    if (!operatorRunning && !mOperatorPath.empty())
    {
        operatorRunning = Run(mOperatorPath);
...
bool BCI2000Connection::Disconnect()
{
    mResult.clear();
...
bool BCI2000Connection::StartExecutable(const std::string &inExecutable, const std::string &inOptions)
{
    ...
    {
        std::string workingDir = inExecutable.substr(0, pos + 1);
