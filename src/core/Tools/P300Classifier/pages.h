...
class DataPage : public QWidget
{
  ...
  public:
    ...
    int mNumSamplesTrainingData;
    int mNumChannelsTrainingData;
    AnalysisMode mModeTrainingData;
    int mNumSamplesTestingData;
    int mNumChannelsTestingData;
    AnalysisMode mModeTestingData;
    bool mWeightsValid;
    bool mTrainingDataFilesValid;
    bool mTestingDataFilesValid;
    bool mFeatureWeightsGenerated;
    bool mMultipleMenusTrainingData;
    bool mMultipleMenusTestingData;
    bool mAutoWrite;
