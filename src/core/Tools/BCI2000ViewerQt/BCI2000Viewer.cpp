////////////////////////////////////////////////////////////////////////////////
// $Id: BCI2000Viewer.cpp 6748 2022-05-18 19:20:40Z mellinger $
...
BCI2000Viewer::ActionEntry BCI2000Viewer::sActions[] = {
    {&BCI2000Viewer::FileOpen, NULL, NULL, "actionOpen", NULL},
    {&BCI2000Viewer::FileClose, &BCI2000Viewer::FileClose_Enabled, NULL, "actionClose", NULL},
    {&BCI2000Viewer::FileExport, &BCI2000Viewer::FileClose_Enabled, NULL, "actionExport", NULL},
    {&BCI2000Viewer::FileQuit, NULL, NULL, "actionQuit", NULL},
...
BCI2000Viewer::BCI2000Viewer(QWidget *parent)
    : QMainWindow(parent), ui(new Ui::BCI2000Viewer), mSamplePos(0), mNumSignalChannels(0), mPositionEdited(false),
      mSamplingRate(0.0), mRemoveMean(false), mpAVControl(nullptr), mpAudioFrameState(nullptr),
...
{
    SetSamplePos(std::max<int64_t>(0LL, mFile.NumSamples() - ui->signalDisplay->Display().NumSamples()));
}
...
void BCI2000Viewer::UpdateSamplePos()
{
...
void BCI2000Viewer::SetSamplePos(int64_t inPos)
{
    if (mFile.IsOpen())
    {
        mSamplePos = inPos;
...
void BCI2000Viewer::MoveSamplePos(int64_t inPosDiff)
{
    ...
    if (inPosDiff != 0 && mFile.IsOpen())
    {
        ...
        else
        {
            ...
            GenericSignal signal = ConstructDisplaySignal(readCursor, ::abs(inPosDiff));
...
void BCI2000Viewer::CreateAVObjects()
{
    ...
    if (mFile.States()->Exists("AudioFrame"))
    {
        ...
        int64_t i = 0;
        while (i < mFile.NumSamples() && *mpAudioFrameState == 0)
