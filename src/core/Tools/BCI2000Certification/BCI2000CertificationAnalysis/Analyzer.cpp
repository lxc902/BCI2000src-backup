////////////////////////////////////////////////////////////////////////////////
// $Id: Analyzer.cpp 6484 2022-01-03 16:59:03Z mellinger $
...
struct Analyzer::Private : Thread, Runnable
{
    ...
    std::atomic<bool> mFinished = false, mCanceled = false;
    ...
    Private(Analyzer *p)
        : p(p), Thread(this, ""), mVidFrameTest(false), mStartTime(0), mOnEngineMessage(&Private::onEngineMessage, this)
    {
