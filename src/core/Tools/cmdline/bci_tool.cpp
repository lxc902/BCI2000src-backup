////////////////////////////////////////////////////////////////////
// $Id: bci_tool.cpp 6484 2022-01-03 16:59:03Z mellinger $
...
int main(int argc, char **argv)
{
    ...
    if (!options.inputFile
             .empty()) // To extract file name in bci_dat2stream to open the file using the BCI2000FileReader class
    {
        toolOptions.push_back("-i" + options.inputFile);
    }
