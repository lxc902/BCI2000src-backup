# ///////////////////////////////////////////////////////////////////////////
# $Id: BCI2000Remote.py 6649 2022-03-30 18:09:31Z jhill $
...
class BCI2000Remote(object):
    ...
    def __init__(self):
        ...
        if sys.platform.startswith('win'):
            ...
            dylib_extension = ""
        for platform_inflection in [ '.64', '.64bit', '.arm64', '.x86_64', '.amd64', '.32', '.32bit', '.x86' ]:
    ...
    def GetSystemState(self):
        return self._get_string_result(self._lib.BCI2000Remote_GetSystemState, self._instance)
