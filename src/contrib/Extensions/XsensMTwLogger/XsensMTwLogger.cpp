/////////////////////////////////////////////////////////////////////////////
// $Id: XsensMTwLogger.cpp 4731 2014-07-03 15:18:03Z mellinger $
...
XsensMTwLogger::StartMTwRecording()
{
	try
	{
		...
		//then measure
		/*if (m_actual_mtw_count == -1)
		{
			throw std::runtime_error("Can not enter measurement mode");
		}*/
...
XsensMTwLogger::StopMTwRecording()
{
	try
	{
		...
		{
			std::ostringstream error;
			error << "Failed to disable radio: " << *m_wireless_master_device;
			throw std::runtime_error(error.str());
		}
	}
	catch (std::exception const& ex)
