...
public:
  ...
  void AddInputAvailableType(IMFMediaType*);
...
protected:
  virtual HRESULT OnProcess(IMFSample* pSample)
  {
    return S_OK;
  }
...
private:
  LONG mRefCount;
  std::vector<com::Ptr<IMFMediaType>> mInputAvailableTypes;
  com::Ptr<IMFMediaType> mpInputType, mpOutputType;
