...
private:
  ...
  static ControllerContainer CreateControllers(int startIndex, int endIndex, const ParamRef& formats);
  static void FindFormat(int index, const ParamRef&, int& width, int& height, int& fps);
  ControllerContainer mControllers;
};
