////////////////////////////////////////////////////////////////////////////////
// $Id: DSISerialADC.cpp 6741 2022-05-16 19:49:38Z nluczak $
...
DSISerialADC::DSISerialADC()
    ...
    mHeadset(NULL)
{
    string dllname = DSI_DYLIB_NAME(NULL);
...
DSISerialADC::DoAcquire(GenericSignal& Output)
{
    ...
    for (int el = 0; el < Output.Elements(); ++el)
        State("Trigger")(el) = Output(nChannels - 1, el);
