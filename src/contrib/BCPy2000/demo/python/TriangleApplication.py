#   $Id: TriangleApplication.py 6686 2022-04-19 21:25:58Z nluczak $
#   
...
class BciApplication(BciGenericApplication):
	...
	def Initialize(self, indim, outdim):
		...
		self.stimulus('cue',      z=5,   stim=psypy.TextBox(self.screen.screen,text='?', size=[200,100],pos=triangle_center,units='pix'),on=False)
