...
# ///////////////////////////////////////////////////////////////////////////
# $Id: Parameters.py 6768 2022-05-28 01:34:14Z jhill $
...
class ParamList(list):
	...
	def __names(self): return [p.Name for p in self if getattr(p, 'Name', None) is not None]
	def __dir__( self ): return list.__dir__( self ) + list( set( p.Name.split( '/' )[ -1 ] for p in self if getattr( p, 'Name', None ) ) )
	_getAttributeNames = __names # for some IPython versions
