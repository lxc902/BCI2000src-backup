###########################################################################
## $Id: AddTargetMacro.cmake 6683 2022-04-13 18:24:02Z mellinger $
  ...
  IF( NOT failed_ )
    ...
    foreach( file_ ${support_} )
      ...
      foreach( file_ ${from_} )
        set( args_
          ${args_}
          COMMAND copy_if_newer "${file_}" "${to_}" VERBATIM
        )
      endforeach()
      ...
      ELSE() # simply copy executable to output directory
        ...
        FOREACH( companion_ ${bundle} )
          ...
          ADD_CUSTOM_COMMAND(
            ...
            POST_BUILD
            COMMAND "${CMAKE_COMMAND}" -E make_directory "${outputDir}"
            COMMAND "${CMAKE_COMMAND}" -E copy_if_different "${from_}" "${outputDir}/${to_}" VERBATIM
          )
        ENDFOREACH()
      ENDIF()
    endif()
